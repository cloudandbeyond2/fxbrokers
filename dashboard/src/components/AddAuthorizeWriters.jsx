...
const handleSubmit = (e) => {
      ...
      <div className='col-lg-12'>
        <div className='card mt-24'>
          <div className='card-header border-bottom'>
            <h6 className='text-xl mb-0'>Add Authorize Writers</h6>
          </div>
  ...
  {/* Submit */}
  <button type='submit' className='btn btn-primary-600 radius-8' style={{ width: "fit-content"}}>
    Submit
  </button>
</form>
...
export default AddAuthorizeWriters;