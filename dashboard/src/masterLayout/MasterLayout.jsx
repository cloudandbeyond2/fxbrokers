    ...
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      >
        ...
        <div>
          ...
          <h6 style={{ textAlign: "center" ,     paddingTop: "16px"}}>Forex</h6>
        </div>
      ...
      <li>
        ...
        >
          ...
          Clients
            ...
            <li className='dropdown'>
              <Link href='#'>
              <Icon icon="material-symbols:manage-accounts-outline" className="menu-icon" />

                <span>Brokers Information</span>
              </Link>
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                ...
                {/* <li>
                  <Link
                    href='/View-Profile-management'
                    className={
                      pathname === "/View-Profile-management" ? "active-page" : ""
                    }>
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                    View Broker Info
                  </Link>
            ...
            <li className='dropdown'>
              ...
              <Icon icon="mdi:newspaper-variant-outline" className="menu-icon" />
                ...
                <span>Blog by Brokers</span>
              </Link>
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    href='/blog-by-brokers'
                    className={
                      pathname === "/blog-by-brokers" ? "active-page" : ""
                    }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                    Add Blog
            ...
            <li className='dropdown'>
              <Link href='#'>
              <Icon icon="mdi:pen-lock" className="menu-icon" />

                <span>Authorize Writers</span>
              </Link>
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    ...
                    className={
                      pathname === "/Authorize-writers" ? "active-page" : ""
                    }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                    Add Authorize Writers
                  </Link>
                </li>
                <li>
                  <Link
                    href='/Authorize-writers-list'
                    className={
                      pathname === "/Authorize-writers-list" ? "active-page" : ""
                    }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                   Authorize Writers List
                  </Link>
                </li>
...
{/*               
      <li>
        <Link
          ...
          className={pathname === '/deposit-requests' ? 'active-page' : ''}
        >
          <i className='ri-circle-fill circle-icon text-primary-600 w-auto' /> Deposit Requests
        </Link>
      </li>
      ...
      <li>
        <Link
          ...
          className={pathname === '/withdrawal-requests' ? 'active-page' : ''}
        >
          <i className='ri-circle-fill circle-icon text-primary-600 w-auto' /> Withdrawal Requests
        </Link>
      </li>
      ...
      <li>
        <Link
          href='/trade-reports'
          className={pathname === '/trade-reports' ? 'active-page' : ''}
        >
          <i className='ri-circle-fill circle-icon text-primary-600 w-auto' /> Trade Reports
        </Link>
      </li>
      ...
      <li>
        ...
        >
          <i className='ri-circle-fill circle-icon text-primary-600 w-auto' /> Commissions
        </Link>
      </li> */}
            ...
            <li className='dropdown'>
              ...
              <Icon icon="mdi:star-circle-outline" className="menu-icon" />
                ...
                <span>Broker Analysis Promotion</span>
              </Link>
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    href='/broker-analysis-promotion'
                    className={
                      pathname === "/broker-analysis-promotion" ? "active-page" : ""
                    }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                    Add Reviews & Ratings
                ...
                <li>
                  <Link
                    href='/promotion-view'
                    className={
                      pathname === "/promotion-view" ? "active-page" : ""
                    }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                    View Brokers Promotion
                  </Link>
                </li>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    ...
                    className={
                      pathname === "/content-submission" ? "active-page" : ""
                    }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    ...
                    className={
                      pathname === "/lead-management" ? "active-page" : ""
                    }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                    Manage Inquiries
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <span className='w-40-px h-40-px rounded-circle flex-shrink-0 position-relative'>
                            <img
                              src='assets/images/notification/starbala.jpg'
                              alt=''
                            />
  ...
  >
    ...
    Log Out
        ...
        <footer className='d-footer'>
          <div className='row align-items-center justify-content-between'>
            <div className='col-auto'>
              <p className='mb-0'>© 2025 Forex. All Rights Reserved.</p>
            </div>
            <div className='col-auto'>
              <p className='mb-0'>
                Made by <span className='text-primary-600'>Forex</span>
              </p>
            </div>
          </div>
        </footer>
